        ...
        <>
          ...
          <div className="my-5">
            ...
            <Row className="my-5">
              ...
              <Col lg={6}>
                <h3 className="text-center mb-3">
                  Este plan cuenta con los siguientes servicios:
                </h3>
                <ul>
                  {planEncontrado.serviciosPlan.map((servicio) => (
                    <li className="plan-description" key={servicio}>
                      {servicio}
                    </li>
                  ))}
                </ul>
            ...
            <p className="plan-description">
              Debido a que nuestra filosofía dicta que cada mascota debe tener
              una atención personalizada, preferimos proporcionar un servicio de
              calidad que esté plenamente ajustado a las características
              individuales de cada mascota. Así, garantizamos que recibirán la
              atención adecuada y los cuidados que merecen.
            </p>
            <p className="plan-description">
              Para contratar un plan te invitamos a acercarte a nuestra
              veterinaria para descubrir cómo podemos brindarle a tu amado amigo
              una vida plena y saludable. ¡Esperamos ansiosamente conocerte a ti
              y a tu peludo compañero!
            </p>
            <p className="plan-description">
        ...
        <>
          <div>
            <h1 className="text-center display-4">
              Hubo un error al cargar el plan
            </h1>
          </div>
          <hr />
          <div>
            <Button as={Link} to={"/planes"}>
              Mejor regresar atras
            </Button>
          </div>
        </>
      );
