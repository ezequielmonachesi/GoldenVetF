...
const CardProducto = () => {
    return (
        ...
        <Card.Img className='img-productos w-100' src='https://nanolog.vtexassets.com/arquivos/ids/165009-800-800?v=637376716541070000&width=800&height=800&aspect=true'></Card.Img>
        </Card.Header>
        <Card.Body>
