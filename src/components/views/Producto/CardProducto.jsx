  ...
  return (
    <Col md={6} lg={3} xs={12} className="mb-1">
      <Card className="shadow-lg p-3 mb-3 bg-body-tertiary rounded">
        ...
        <Link to={'/error404'} className="boton-verMas-producto fw-semibold rounded-pill">
        <Cart4 className="mb-1"/> Comprar
        </Link>
          <Link to={'/detalleProducto'+producto.id} className="boton-verMas-producto fw-semibold rounded-pill">
