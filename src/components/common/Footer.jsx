      ...
      <footer className="bg-footer text-light text-center p-5">
        <article className="row w-100">
          <section className="col-md-4">
            <h3>Nuestas redes</h3>
            <p>
              Instagram <Instagram className="text-black fs-4" />
            </p>
            <p>
              Facebook <Facebook className="text-black fs-4" />
            </p>
            <p>
              Twitter <Twitter className="text-black fs-4" />
            </p>
          </section>
          ...
          <section className="col-md-4">
            ...
            <p>
              <GeoAltFill className="text-black fs-4" /> AV. xxxx al xxx
            </p>
            <h3>Telefono de contacto</h3>
            <p>
              <TelephoneFill className="text-black fs-4" /> xxxx-xxxxxx
            </p>
          </section>
        </article>
      </footer>
